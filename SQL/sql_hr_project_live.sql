...
-- 2.Display the department information from the department table.
select * from departments;

-- 3.Display the name and job for all employees
select j.job_title ,concat(e.first_name," ",e.last_name) as name from employees e left join jobs j on e.job_id = j.job_id;

-- 4.Display the name and salary for all employees.
select concat(first_name," ",last_name) as name,salary from employees;

-- 5.Display the employee number and total salary for all employees.
select employee_id , salary + ifnull(commission_pct * salary,0) as total from employees;

-- 6.Display the employee name and annual salary for all employees.
select employee_id , 12*(salary + ifnull(commission_pct * salary,0)) as anual_salary from employees;
...
select e.first_name , j.job_title ,e.salary from employees e  join jobs j on e.job_id=j.job_id where j.job_title="clerks" and e.salary>3000;

-- 9. the employee number and name of employees who are earning commission.
select first_name as name , employee_id from employees where commission_pct is not null ;

-- 10.Display the employee number and name of employees who do not earn any commission.
select employee_id , first_name as name from employees where commission_pct is null;

-- 11.Display the names of employees who are working as clerks, salesmen, or analysts and drawing a salary more than 3000.
select e.first_name , j.job_title ,e.salary from employees e  join jobs j on e.job_id=j.job_id where j.job_title in("clerks","salesmen","analysts")and salary>3000;
...
-- 13.Display the list of employees who joined the company before 30-JUN-90 or after 31-DEC-90.
select first_name from employees where hire_date < "1990,06,30" or hire_date > "1990,12,31";
...
-- 16 . Display names of all table from current_user .
SELECT table_name 
...
-- 18.Display the names of employees working in department 10, 20, or 40 or employees working as clerks, salesmen, or analysts.
select e.first_name , d.department_name,d.department_id , j.job_title 
from employees e 
left join departments d on e.department_id = d.department_id 
left join jobs j on e.job_id=j.job_id
where d.department_id in(10,20,40) or j.job_title in("salesmen","clerk","analyst");

-- 19. Display the names of employees whose name starts with S.
select first_name from employees 
where first_name like 's%';

-- 20. Display employee names whose name ends with S.
SELECT first_name, last_name
FROM employees WHERE first_name LIKE '%S';

-- 21. Display names of employees whose second alphabet is A.
SELECT first_name, last_name
FROM employees WHERE first_name LIKE '_A%';

-- 22. Select employee names whose name is exactly five characters long.
SELECT first_name, last_name
FROM employees
...
-- 23. Display names of employees who are not working as MANAGERS.
SELECT e.employee_id,
...
-- 24. Display names of employees not working as Salesman, Clerk, or Analyst.
SELECT e.first_name,j.job_title 
FROM employees e
join jobs j on e.job_id=j.job_id
WHERE j.job_title NOT IN ('SALESMAN','CLERK','ANALYST');
